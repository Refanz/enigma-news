        ...
        <div className="navbar bg-base-100 max-w-screen-xl">
            <div className="navbar-start  gap-2">
                <div className="border-r-2 border-r-black px-2">
                    <a className="text-xl font-bold text-red-600 cursor-pointer" onClick={() => props.onChangePage("home")}>EnigmaNews</a>
                </div>
            ...
            <div className="navbar-end dropdown md:hidden flex">
